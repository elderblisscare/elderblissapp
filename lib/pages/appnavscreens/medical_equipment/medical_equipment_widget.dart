...
class MedicalEquipmentWidget extends StatefulWidget {
  ...
  static String routePath = 'medicalEquipment';
...
class _MedicalEquipmentWidgetState extends State<MedicalEquipmentWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'MedicalEquipment'});
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MEDICAL_EQUIPMENT_arrow_back_ICN_ON_TAP');
                              ...
                              children: [
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'MEDICAL_EQUIPMENT_SCHEDULE_SERVICE_BTN_O');
