                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              '\nWellness Assistance Center\nDigital Medical Records\nMonitoring Regular Medication & \nTest\nHealth Parameters Monitoring\nDoctor Tele-Consult\nDigital Dashboard\nGuardian Visit\nCare calls by Guardian\nCare Manager Check in\nGroceries or Amenities Delivery\nValue added services\nTravel Helpdesk\nEmergency Coordination\nEmergency Response\nFull Body Check-up Yearly',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'VIEW_PLANS_SELECT_BASIC_PLAN_BTN_ON_TAP');
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'All Bliss plan features\nDoctor Visit\nWelcome Surprise\nGuardian Visit\nCare Campanion\nGroceries or Amenities Delivery\nActive Outdoor Living\nCompanion Care During Hospitalisation\nFull Body Check-up twice a Year',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'VIEW_PLANS_SELECT_PREMIUM_PLAN_BTN_ON_TA');
                                        logFirebaseEvent('Button_launch_u_r_l');
                                        await launchURL(
                                            'https://wa.me/message/BFIUAWXCKN3BM1');
                                      },
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'Wellness Assistance Center\nDigital Medical Records\nMonitoring Regular Medication & Tests\nHealth Parameters Monitoring\nDoctor Tele-Consult\nDigital Dashboard\nGuardian Visit\nCare calls by Guardian\nCare Manager Check in\nGroceries or Amenities Delivery\nValue added services\nTravel Helpdesk\nEmergency Coordination\nEmergency Response\nFull Body Check-up Yearly\n+ Choose Any other services',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'VIEW_PLANS_SELECT_CUSTOM_PLAN_BTN_ON_TAP');
                                        logFirebaseEvent('Button_launch_u_r_l');
                                        await launchURL(
                                            'https://wa.me/message/BFIUAWXCKN3BM1');
                                      },
                                      text: 'Select Custom Plan',
                                      options: FFButtonOptions(
                                        width:
                                            MediaQuery.sizeOf(context).width *
                                                1.0,
