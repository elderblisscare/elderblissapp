                  ...
                  Row(
                    ...
                    children: [
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'CONTACTUS_PAGE_arrow_back_ICN_ON_TAP');
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CONTACTUS_PAGE_Row_bh2rdcr2_ON_TAP');
                                logFirebaseEvent('Row_launch_u_r_l');
                                await launchURL(
                                    'https://www.linkedin.com/company/elder-bliss-care/');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CONTACTUS_PAGE_Row_im41clly_ON_TAP');
                                logFirebaseEvent('Row_launch_u_r_l');
                                await launchURL(
                                    'https://www.instagram.com/elderblisscare/');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CONTACTUS_PAGE_Row_7k1ku0b3_ON_TAP');
                                logFirebaseEvent('Row_launch_u_r_l');
                                await launchURL(
                                    'https://www.facebook.com/elderblisscare');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
